...
def excel_managesalary(message):
    ...
    with open(r"C:\Users\DigiBaaran\Documents\managesalaryexcel.xlsx","rb") as f:
...
class CalculationPayment:
    ...
    def insert_excel_role_info(self,message):
        wb = openpyxl.load_workbook(r"C:\Users\DigiBaaran\Documents\managesalaryexcel.xlsx")
        sheet = wb.active
        today = datetime.now()
        ...
        wb.save(r"C:\Users\DigiBaaran\Documents\managesalaryexcel.xlsx")
        wb.close()
        return
